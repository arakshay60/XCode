    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verdict', models.CharField(default='', max_length=50)),
                ('sub_time', models.DateTimeField(auto_now=True, null=True)),
                ('language', models.CharField(choices=[('C++', 'C++'), ('Python3', 'Python3'), ('Java', 'Java')], default='C++', max_length=10)),
                ('runtime', models.DecimalField(decimal_places=2, default=0, max_digits=5, null=True)),
